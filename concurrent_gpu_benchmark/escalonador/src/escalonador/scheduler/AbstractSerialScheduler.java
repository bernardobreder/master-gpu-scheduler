...
public class AbstractSerialScheduler {

	protected List<List<Entry<Integer, Kernel>>> roundsStep;

	protected List<Entry<Integer, Kernel>> initialKernels;
	...
	public List<List<Entry<Integer, Kernel>>> getRoundsStep() {
		return roundsStep;
	}
